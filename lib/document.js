...
class Document {
  ...
  li(text) { const el = this.createElement('li'); if (text != null) el.text(text); return el; }
  table() { return this.createElement('table'); }
  tr() { return this.createElement('tr'); }
  th(text) { const el = this.createElement('th'); if (text != null) el.text(text); return el; }
  td(text) { const el = this.createElement('td'); if (text != null) el.text(text); return el; }
  ...
  h1() { return this.createElement('h1'); }
  h2() { return this.createElement('h2'); }
  h3() { return this.createElement('h3'); }
  h4() { return this.createElement('h4'); }
  h5() { return this.createElement('h5'); }
  h6() { return this.createElement('h6'); }
