...
class Element {
  ...
  li(text) { const el = this.child('li'); if (text != null) el.text(text); return el; }
  table() { return this.child('table'); }
  tr() { return this.child('tr'); }
  th(text) { const el = this.child('th'); if (text != null) el.text(text); return el; }
  td(text) { const el = this.child('td'); if (text != null) el.text(text); return el; }
  ...
  h1() { return this.child('h1'); }
  h2() { return this.child('h2'); }
  h3() { return this.child('h3'); }
  h4() { return this.child('h4'); }
  h5() { return this.child('h5'); }
  h6() { return this.child('h6'); }
