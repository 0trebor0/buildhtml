...
const { sanitizeFunctionSource, sanitizeCssValue, sanitizeUrl, URL_ATTRS, safeJsonStringify, toKebab, escapeHtml, isValidAttrKey, isValidTagName, clientUrlSanitizerBody, clientAttrKeyValidatorBody, clientCssValueSanitizerBody } = require('./utils');
...
const MK_EL_SRC =
  'window._mkEl=(function(){' +
    ...
    'function sv(v){' + clientCssValueSanitizerBody('v') + '}' +
    'function mk(d){' +
      'if(!d)return null;' +
