 ...
 *
 * Registration options are not passed through: the only one that exists is
 * `tag`, and callers consume it to pick the element before this runs.
 */
function applyComponent(el, fn, props = {}) {
